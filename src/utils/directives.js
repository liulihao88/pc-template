...
const waterPng = require("@/assets/404_images/404.png");
...
Vue.directive("water", {
  bind: function (el, binding) {
    console.log(`%c 451行 src/utils/directives.js el`, "color:blue", el);
    const { clientWidth, clientHeight, parentElement } = el;
    console.log(
      `%c 454行 src/utils/directives.js clientWidth`,
      "color:blue",
      clientWidth
    );
    ...
    waterBg.setAttribute(
      ...
      height: 100%;
      opacity: 0.2;
      background-image: url(${waterPng}); 
      background-repeat: repeat;`
    );
    console.log(
      `%c 1133 483行 src/utils/directives.js waterBg `,
      "background:#000;color:#ba5",
      waterBg
    );
  ...
  inserted: function (el, binding) {
    console.log(`%c 499行 src/utils/directives.js el`, "color:blue", el);
    const { clientWidth, clientHeight, parentElement } = el;
    console.log(
      `%c 502行 src/utils/directives.js clientWidth`,
      "color:blue",
      clientWidth
    );
    ...
    waterBg.setAttribute(
      ...
      background-image: url(${waterPng}); 
      background-repeat: repeat;
      background: url(${waterPng}) 20 20 repeat;
      `
    );
    console.log(
      `%c 1133 483行 src/utils/directives.js waterBg `,
